...
Array.from(document.getElementsByClassName('card_pepsi')).forEach((ele, i)=>{
    ele.addEventListener('click',()=>{
        ...
        document.getElementById('carbo').innerText= pepsi[i].carbohytred;
        document.getElementById('carbo1').innerText= pepsi[i].carbohytred_per;
...
document.getElementById('left_btn').addEventListener('click',()=>{
    ...
    if (index < 0) {
        ...
        document.getElementById('carbo').innerText= pepsi[index].carbohytred;
        document.getElementById('carbo1').innerText= pepsi[index].carbohytred_per;
